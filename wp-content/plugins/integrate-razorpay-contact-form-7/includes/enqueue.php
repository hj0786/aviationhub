...
function cf7rzp_public_enqueue(){
    ...
    wp_enqueue_script('cf7rzp-main',plugins_url('/assets/js/main.js',__DIR__),array('jquery'),1.0);
	...
	wp_enqueue_style( 'cf7rzp-styles', CF7RZP_DIR_URL.'assets/css/styles.css');
}
